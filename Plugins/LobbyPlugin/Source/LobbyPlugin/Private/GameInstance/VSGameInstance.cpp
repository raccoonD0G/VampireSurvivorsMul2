...
#include "GameInstance/LobbyGameInstance.h"
...
void ULobbyGameInstance::RequestJoinMatch()
{
    ...
    Request->OnProcessRequestComplete().BindUObject(this, &ULobbyGameInstance::OnJoinMatchResponse);
    Request->ProcessRequest();
}

void ULobbyGameInstance::OnJoinMatchResponse(FHttpRequestPtr Request, FHttpResponsePtr Response, bool bWasSuccessful)
{
